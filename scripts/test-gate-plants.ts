...
const B1_SCENARIOS: Scenario[] = [
  ...
  /**
   * ⛔ **[.5.7 ② · backlog from `.5.4g`] — `--projected`: A TREE THAT WOULD WALK PAST THE STALE CEILING ONCE COMMITTED.**
   *
   * Nine proven entries whose proof target is the tracked plant fixture, APPENDED to by `edit` — a real uncommitted
   * change to a tracked file. `git log HEAD..HEAD` is empty, so none is stale by commit; all nine are stale the moment
   * the edit is committed. Only the projection counts them, and only `--projected` turns 0 + 9 > 8 into a refusal.
   * ⚠️ **The first cut targeted this harness's own scratch file and redded for the WRONG reason** — `.gitignore:62`
   * ignores `scripts/__gate_plant_*`, so `git status --porcelain` never lists it and the projection counted nothing. A
   * real edit is never an ignored file; the plant had to be one git can see. ⚠️ The control runs the real registry
   * WITHOUT the flag: a gate file edited mid-build projects its own anchored proofs, and that must not red the control.
   */
  {
    gate: 'lint:finding-guards [projected]',
    script: 'check-finding-guards.ts',
    args: ['--registry=scripts/__gate_plant_registry__.json', '--projected'],
    controlArgs: [],
    at: 'scripts/__gate_plant_guard__.ts',
    body: "check(plantedProjected1);\ncheck(plantedProjected2);\ncheck(plantedProjected3);\ncheck(plantedProjected4);\ncheck(plantedProjected5);\ncheck(plantedProjected6);\ncheck(plantedProjected7);\ncheck(plantedProjected8);\ncheck(plantedProjected9);\n",
    also: [{ at: 'scripts/__gate_plant_registry__.json', body: "{\n  \"PLANT-PROJECTED-1\": {\n    \"what\": \"a proven guard whose proof target has an UNCOMMITTED change - stale the moment it is committed\",\n    \"file\": \"scripts/__gate_plant_guard__.ts\",\n    \"token\": \"check(plantedProjected1);\",\n    \"proof\": {\n      \"unfix\": [\n        {\n          \"at\": \"scripts/__fixtures__/authoring-plant-target.md\",\n          \"find\": \"# The tracked file `test:gate-plants` edits\",\n          \"replace\": \"# planted\"\n        }\n      ],\n      \"run\": \"lint:finding-guards\",\n      \"measured\": \"2026-09-13\",\n      \"sha\": \"HEAD\"\n    }\n  },\n  \"PLANT-PROJECTED-2\": {\n    \"what\": \"a proven guard whose proof target has an UNCOMMITTED change - stale the moment it is committed\",\n    \"file\": \"scripts/__gate_plant_guard__.ts\",\n    \"token\": \"check(plantedProjected2);\",\n    \"proof\": {\n      \"unfix\": [\n        {\n          \"at\": \"scripts/__fixtures__/authoring-plant-target.md\",\n          \"find\": \"# The tracked file `test:gate-plants` edits\",\n          \"replace\": \"# planted\"\n        }\n      ],\n      \"run\": \"lint:finding-guards\",\n      \"measured\": \"2026-09-13\",\n      \"sha\": \"HEAD\"\n    }\n  },\n  \"PLANT-PROJECTED-3\": {\n    \"what\": \"a proven guard whose proof target has an UNCOMMITTED change - stale the moment it is committed\",\n    \"file\": \"scripts/__gate_plant_guard__.ts\",\n    \"token\": \"check(plantedProjected3);\",\n    \"proof\": {\n      \"unfix\": [\n        {\n          \"at\": \"scripts/__fixtures__/authoring-plant-target.md\",\n          \"find\": \"# The tracked file `test:gate-plants` edits\",\n          \"replace\": \"# planted\"\n        }\n      ],\n      \"run\": \"lint:finding-guards\",\n      \"measured\": \"2026-09-13\",\n      \"sha\": \"HEAD\"\n    }\n  },\n  \"PLANT-PROJECTED-4\": {\n    \"what\": \"a proven guard whose proof target has an UNCOMMITTED change - stale the moment it is committed\",\n    \"file\": \"scripts/__gate_plant_guard__.ts\",\n    \"token\": \"check(plantedProjected4);\",\n    \"proof\": {\n      \"unfix\": [\n        {\n          \"at\": \"scripts/__fixtures__/authoring-plant-target.md\",\n          \"find\": \"# The tracked file `test:gate-plants` edits\",\n          \"replace\": \"# planted\"\n        }\n      ],\n      \"run\": \"lint:finding-guards\",\n      \"measured\": \"2026-09-13\",\n      \"sha\": \"HEAD\"\n    }\n  },\n  \"PLANT-PROJECTED-5\": {\n    \"what\": \"a proven guard whose proof target has an UNCOMMITTED change - stale the moment it is committed\",\n    \"file\": \"scripts/__gate_plant_guard__.ts\",\n    \"token\": \"check(plantedProjected5);\",\n    \"proof\": {\n      \"unfix\": [\n        {\n          \"at\": \"scripts/__fixtures__/authoring-plant-target.md\",\n          \"find\": \"# The tracked file `test:gate-plants` edits\",\n          \"replace\": \"# planted\"\n        }\n      ],\n      \"run\": \"lint:finding-guards\",\n      \"measured\": \"2026-09-13\",\n      \"sha\": \"HEAD\"\n    }\n  },\n  \"PLANT-PROJECTED-6\": {\n    \"what\": \"a proven guard whose proof target has an UNCOMMITTED change - stale the moment it is committed\",\n    \"file\": \"scripts/__gate_plant_guard__.ts\",\n    \"token\": \"check(plantedProjected6);\",\n    \"proof\": {\n      \"unfix\": [\n        {\n          \"at\": \"scripts/__fixtures__/authoring-plant-target.md\",\n          \"find\": \"# The tracked file `test:gate-plants` edits\",\n          \"replace\": \"# planted\"\n        }\n      ],\n      \"run\": \"lint:finding-guards\",\n      \"measured\": \"2026-09-13\",\n      \"sha\": \"HEAD\"\n    }\n  },\n  \"PLANT-PROJECTED-7\": {\n    \"what\": \"a proven guard whose proof target has an UNCOMMITTED change - stale the moment it is committed\",\n    \"file\": \"scripts/__gate_plant_guard__.ts\",\n    \"token\": \"check(plantedProjected7);\",\n    \"proof\": {\n      \"unfix\": [\n        {\n          \"at\": \"scripts/__fixtures__/authoring-plant-target.md\",\n          \"find\": \"# The tracked file `test:gate-plants` edits\",\n          \"replace\": \"# planted\"\n        }\n      ],\n      \"run\": \"lint:finding-guards\",\n      \"measured\": \"2026-09-13\",\n      \"sha\": \"HEAD\"\n    }\n  },\n  \"PLANT-PROJECTED-8\": {\n    \"what\": \"a proven guard whose proof target has an UNCOMMITTED change - stale the moment it is committed\",\n    \"file\": \"scripts/__gate_plant_guard__.ts\",\n    \"token\": \"check(plantedProjected8);\",\n    \"proof\": {\n      \"unfix\": [\n        {\n          \"at\": \"scripts/__fixtures__/authoring-plant-target.md\",\n          \"find\": \"# The tracked file `test:gate-plants` edits\",\n          \"replace\": \"# planted\"\n        }\n      ],\n      \"run\": \"lint:finding-guards\",\n      \"measured\": \"2026-09-13\",\n      \"sha\": \"HEAD\"\n    }\n  },\n  \"PLANT-PROJECTED-9\": {\n    \"what\": \"a proven guard whose proof target has an UNCOMMITTED change - stale the moment it is committed\",\n    \"file\": \"scripts/__gate_plant_guard__.ts\",\n    \"token\": \"check(plantedProjected9);\",\n    \"proof\": {\n      \"unfix\": [\n        {\n          \"at\": \"scripts/__fixtures__/authoring-plant-target.md\",\n          \"find\": \"# The tracked file `test:gate-plants` edits\",\n          \"replace\": \"# planted\"\n        }\n      ],\n      \"run\": \"lint:finding-guards\",\n      \"measured\": \"2026-09-13\",\n      \"sha\": \"HEAD\"\n    }\n  }\n}\n" }],
    edit: [{ at: "scripts/__fixtures__/authoring-plant-target.md", append: "\n[.5.7 projected-staleness plant: this line makes the file an uncommitted change]\n" }],
    expect: 'as if committed',
    why: 'staleness asks `git log sha..HEAD` only, so a close could pass this gate and fail it one commit later — the `.5.4f` shape',
  },
  {
