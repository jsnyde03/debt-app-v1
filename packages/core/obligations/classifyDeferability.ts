 ...
 * KNOWN to be deferrable (subscriptions, and [D25]'s one-off `discretionary` buys) default to
 * deferrable; everything else — the essential
 ...
 */
const DEFERRABLE_CATEGORIES: readonly RequiredExpenseCategory[] = ["subscriptions", "discretionary"];
