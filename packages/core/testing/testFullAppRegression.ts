...
function testTimelineRunningCashEndToEnd() {
	...
	const tight = allocatePaycheck({
		...
		nextPaycheckDate: "2026-06-15",
		expenses: [
			{ id: "rent", name: "Rent", amount: 1200, dueDate: "2026-06-05", recurrence: "monthly" as const },
			{ id: "power", name: "Power", amount: 300, dueDate: "2026-06-07", recurrence: "monthly" as const },
		],
		debts: [],
		goals: [],
		strategy: "snowball",
	...
	const tightTimeline = buildTimelineItems({
		result: tight,
		requiredExpenses: [
			{ id: "rent", name: "Rent", amount: 1200, dueDate: "2026-06-05", recurrence: "monthly" as const },
			{ id: "power", name: "Power", amount: 300, dueDate: "2026-06-07", recurrence: "monthly" as const },
...
function testTimelineAllocationItemsAllPresent() {
	...
	const timelineWithCompletedActions = buildTimelineItems({
		...
		completedRecommendedActions: [
			...
			{ targetId: "visa", label: "Extra payment to Visa", category: "snowball", recommendedAmount: 175, actualAmount: 175 },
...
function testTimelineAllocationsAppearAfterExpenses() {
	...
	const timeline = buildTimelineItems({
		...
		debts,
		completedRecommendedActions: [
			{ targetId: "visa", label: "Extra payment to Visa", category: "snowball", recommendedAmount: 100, actualAmount: 100 },
		],
		currentDate: "2026-06-01",
		nextPaycheckDate: "2026-06-15",
	});
		...
		completedRecommendedActions: [
			{
				...
				category: "snowball",
				recommendedAmount: snowballAllocation.amount,
