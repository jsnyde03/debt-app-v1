...
| **L2d** | Beat 1's Guardian card shows a visible gap at its bottom where the replay link is withheld in sandbox. Withholding rather than disabling is the correct shape (round 8 lens C), but the row's space appears to remain. From the 2026-08-06 device capture — **measure before treating it as a defect.** | polish, unconfirmed | 3.5.6 |
