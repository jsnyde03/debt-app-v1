...
- **Journey hero — decided: milestones ON the ring** (Jason 2026-07-21), green→gold arc, count-up, glow; a **status display** (interactivity deferred → Phase 3 tappable-milestone detail).
  ...
  - Then: **P3 MomentumStats de-dupe** (drop "Paid so far"; the ring hero already owns % + date + paid; CountUp + a genuinely-additive 2nd metric) · **P2 Skia cushion bars**. Target: **hero → trajectory → interest-saved → cash-flow**.
