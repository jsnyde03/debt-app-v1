...
| **P6.8.7** | **Build what 🎯 admits**, defer the rest to 2.1 with the reason recorded against the finding id |
| **P6.8.8** | **`validate:release:rn` green** *(it now records itself — do not type the result)* |
