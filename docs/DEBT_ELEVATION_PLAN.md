...
| # | sub-step | exit line |
|---|---|---|
| **S1.13.7.10.1** | **COUNT THE IDS FROM THE LANE FILES**, not from the list above — every `###` heading across `A1` `A2` `A3` `B2` `D1`, reconciled against 18. ⛔ `F-B5` was in no list on this plan and surfaced only by counting | a reconciled count, and any id the list omits named |
