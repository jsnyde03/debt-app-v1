...
- [ ] **2.5.2** Trial capture UI — a "trial / intro price" toggle in `ExpenseSheet` revealing full-price + kick-in-date (mirrors the BNPL reveal in `DebtSheet`); design-shaped w/ Jason.
