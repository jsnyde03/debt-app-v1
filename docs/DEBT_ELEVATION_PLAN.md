...
▶ **`S1.10.6.5.8`, sub-steps `.8.5`–`.8.7`** — decomposed below. ⛔ **Read the live count from `npm run lint:finding-guards`, never from here** *(`MAX_UNGUARDED` has moved **16 → 13 → 10** across this session and the last)*.
