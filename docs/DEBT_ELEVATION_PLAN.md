...
| **S1.11.5** | **CLASS 2/3/5 — the rest.** `A-F3` *(blocker: `windowStartISO` accepted and never read — $1,200 against a true $300)* · `A-F1` `A-F2` `F-B1` `C4-3` `C4-6` `C4-4` `F-B2` `D4-1` `D4-10` `D4-4` `D4-7` · the 7 minors. ⛔ `C4-2` moved to `S1.11.4.2` and `C4-1` to `S1.11.4.4` — each is a `PARTIAL`'s open half and the plan carried it in both places | each carries **two plants** — the defect, and the laziest plausible repair |
