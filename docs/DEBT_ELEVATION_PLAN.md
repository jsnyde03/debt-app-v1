...
| **S1.13.7.10.3** | **ORACLES THAT ARE NO-OPS OVER MOST OF THEIR POPULATION** — `D1-4`: the migration audit's oracle is a no-op for **542 of 1,084** outcomes while printing *"all 9 invariants fire"* | the population derived, the printed claim matching what ran |
