...
| 3.5.8.5 | **Recorder + conform** — record raw, then ffmpeg → 886×1920, CFR 30, H.264 10–12 Mbps, ≤30s. Asserted against the spec, not eyeballed |
| 3.5.8.6 | **The workflow** — boot the largest iPhone, force DARK, install, openurl, Maestro paces + taps the payoff, record, conform, upload. `brew install ffmpeg` (NOT preinstalled on `macos-15`) |
