...
| 3.5.8.2 | **[D20a] the closing caption** — one restrained line over beat 5 carrying the IAP disclosure and the muted viewer's single anchor of text |
...
| 3.5.8.7 | **Verify the FIRST frame of every beat** from the recording itself — Skia painted, numbers right. An empty chart in a store video is worse than no video |
