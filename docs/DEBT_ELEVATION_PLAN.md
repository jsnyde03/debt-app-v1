...
- [ ] **2.5.4** Wire into plan / Guardian + a gentle payday-confirm prompt only when a signal fires this cycle ("trial ends this cycle — enter the real price?"), never a persistent nag.
- [ ] **2.5.5** Verify — both themes + tests (a scenario if apt).
