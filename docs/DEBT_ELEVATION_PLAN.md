...
- [ ] **2.11.4** port + reskin `PaywallScreen` to the Debt premium visual language (both themes), Debt feature list, **+ Annual/Lifetime** (3-plan layout, monthly already live) + disclosure; Apple 3.1.2 compliant (billed price most prominent · auto-renew disclosure · Terms/Privacy links · **restore = load-bearing for existing subs**).
