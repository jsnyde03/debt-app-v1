...
| 3.5.8.4 | **The two open capture defects** — the debt-free date shifting a year on beat 5 only (`balanceAsOfDate` suspected, unproven) · the unpainted Skia canvases. Both must die before a cut is worth reviewing |
