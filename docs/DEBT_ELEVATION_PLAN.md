...
| ▶ **S1.13.4** | ⛔ **[DECISION] 🎯 DISPATCH — the route is verified and NOT yet dispatched.** **607 files** across four lanes *(182 · 148 · 202 · 75)*, vs pass 5's 393 routed / **86 money files actually read**. Exit is `audit:read-coverage --pass=s1p6` at **446/446**, so this pass reads **~5× what pass 5 did**. Spend must be quoted before an agent is spawned; no sub-agents inside lanes; incremental writes | 🎯 a go/no-go with the spend named |
