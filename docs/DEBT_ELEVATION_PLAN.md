...
| **.12.6.6** | **MONEY WRITTEN OR DESTROYED** — `B2-1` · `B2-3` · `B3-2` | 12 | every money write through one normaliser, asserted over the actions |
