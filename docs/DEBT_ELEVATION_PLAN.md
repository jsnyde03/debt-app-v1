...
| **5.10** | **[AUDIT GATE] Adversarial migration audit.** ⛔ NARROWED (🎯) to *can the migration lose or corrupt data?* | ✅ **GREEN 2026-08-19.** 5.10.1–5.10.4 done: 482 generated cases × 2 REAL doors × 8 invariants + the differential oracle + interruption/quarantine, **0 violations**, gating in `test:app`. Found and fixed **3 real defects**. ▶ Remaining: **5.10.5** agent-generated inputs — ⚠️ now has a HIGHER bar to clear, since the invariants found all three unaided |
