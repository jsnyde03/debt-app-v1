...
| **S1.13.7.10.5** | **THE REMAINDER**, each verified against current code before anything is written — `A1-1` `A1-2` `A1-3` `A1-6` `A1-7` `A1-8` `A1-10` `A1-11` `A2-7` `A3-4` `A3-14`–`A3-16` `D1-6` | closed, or measured never to have been a finding |
