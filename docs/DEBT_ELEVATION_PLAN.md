...
## ▶ RIGHT NOW — **S1.12.5.4 · CLASS IV — a population that is an enumeration** *(CLASS I–III closed)*
...
| ▶ **S1.12.5.4** | **CLASS IV — a population that is an enumeration.** `D5-13` `D5-9` `D5-12` `B5-7` `B5-12` `B5-8` `C5-1` `C5-5`. ⚡ D's prescription: **enumerate what is ACCOUNTED FOR and refuse the remainder** | one pattern at every site; a new member joins or the gate reds |
