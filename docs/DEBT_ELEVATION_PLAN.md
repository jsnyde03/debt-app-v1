...
| # | Step |
|---|---|
| 3.5.8.1 | **[D20b] the persona's weight** — 2 debts/$2,260 → 3 debts/~$18–25k. ⚠️ `personaDebts` is SHARED with the walkthrough and deliberately small "so the payoff beats resolve in-tutorial"; the bill solver throws `infeasible` if minimums crowd the paycheck, and a bigger balance moves the debt-free date the Progress beat is about. Measure all three, then decide shared-vs-demo-specific |
