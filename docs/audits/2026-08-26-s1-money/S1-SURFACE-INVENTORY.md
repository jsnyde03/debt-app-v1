...
| file | swept by |
|---|---|
| `apps/rn/src/analytics/funnel.test.ts` | s1p3 |
| `apps/rn/src/analytics/funnel.ts` | s1p3 |
...
| `apps/rn/src/components/money/BillBreakdownSheet.tsx` | s1p3 |
| `apps/rn/src/components/money/BnplCalendarSection.tsx` | s1p3 |
| `apps/rn/src/components/more-button.tsx` | s1p3 |
| `apps/rn/src/components/more/BackupSheets.tsx` | s1p3 |
| `apps/rn/src/components/more/CloudBackupSheet.tsx` | ⛔ **partial** |
...
| `apps/rn/src/components/onboarding/FirstDebtOrBillStep.tsx` | ⛔ **partial** |
| `apps/rn/src/components/onboarding/OnboardingLayout.tsx` | s1p3 |
| `apps/rn/src/components/onboarding/PaycheckStep.tsx` | ⛔ **partial** |
...
| `apps/rn/src/components/payoff/WhatIfControls.tsx` | s1p3 |
...
| `apps/rn/src/components/payoff/trajectoryDomain.test.ts` | s1p3 |
| `apps/rn/src/components/payoff/trajectoryDomain.ts` | s1p3 |
...
| `apps/rn/src/components/progress/PaidOffArchive.tsx` | s1p3 |
...
| `apps/rn/src/hooks/spotlightGeometry.ts` | ⛔ **partial** |
| `apps/rn/src/hooks/use-app-colors.ts` | s1p3 |
| `apps/rn/src/hooks/use-app-lock.ts` | s1p3 |
| `apps/rn/src/hooks/use-cloud-backup.ts` | s1p3 |
...
| `apps/rn/src/liveActivity/paydayActivityContent.test.ts` | s1p3 |
| `apps/rn/src/liveActivity/paydayActivityContent.ts` | s1p3 |
...
| `apps/rn/src/storage/cloudBackup/createCloudBackupProvider.ios.ts` | s1p3 |
...
| `apps/rn/src/utils/scrubBreadcrumb.ts` | s1p3 |
...
| `apps/rn/src/widget/widgetSync.test.ts` | s1p3 |
...
| `apps/rn/tests/e2e/amount-guards.spec.ts` | s1p3 |
...
| `apps/rn/tests/e2e/on-plan-streak.spec.ts` | s1p3 |
...
| `packages/core/debt/applyRolloverPayment.ts` | s1p3 |
| `packages/core/debt/bnplInstallment.ts` | s1p3 |
...
| `packages/core/debt/bulkMarkRequired.ts` | s1p3 |
...
| `packages/core/debt/getDebtsWithDisplayBalances.ts` | s1p3 |
...
| `packages/core/debt/projectDebtPayoff.ts` | s1p3 |
...
| `packages/core/debt/testBnplInstallment.ts` | s1p3 |
...
| `packages/core/debt/testDebtProjection.ts` | s1p3 |
...
| `packages/core/forecast/projectForecast.ts` | s1p3 |
...
| `packages/core/history/buildCycleSnapshot.ts` | s1p3 |
...
| `packages/core/insights/buildSmartInsights.ts` | s1p3 |
...
| `packages/core/utils/amountField.ts` | s1p3 |
...
| `packages/core/utils/testAmountField.ts` | s1p3 |
