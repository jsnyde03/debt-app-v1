...
| `apps/rn/src/appIntents/pendingActionBridge.native.ts` | s1p3 |
| `apps/rn/src/appIntents/pendingActionBridge.ts` | s1p3 |
| `apps/rn/src/appIntents/pendingActionBridge.types.ts` | s1p3 |
| `apps/rn/src/appIntents/pendingActions.test.ts` | s1p3 |
| `apps/rn/src/appIntents/pendingActions.ts` | s1p3 |
| `apps/rn/src/components/AppLockGate.tsx` | s1p3 |
| `apps/rn/src/components/DataResetScreen.tsx` | s1p3 |
| `apps/rn/src/components/SaveFailedBanner.tsx` | s1p3 |
...
| `apps/rn/src/components/more/CoachMarkProbeReadout.tsx` | never · s1p4 |
| `apps/rn/src/components/more/LegacyBridgeProbeReadout.tsx` | never · s1p4 |
| `apps/rn/src/components/more/LiveActivityQA.tsx` | never · s1p4 |
| `apps/rn/src/components/more/ReduceMotionProbeReadout.tsx` | never · s1p4 |
| `apps/rn/src/components/more/SettingRow.tsx` | never · s1p4 |
| `apps/rn/src/components/onboarding/CompletionStep.tsx` | s1p3 |
| `apps/rn/src/components/onboarding/FirstDebtOrBillStep.tsx` | partial · s1p4 |
| `apps/rn/src/components/onboarding/OnboardingLayout.tsx` | s1p3 |
| `apps/rn/src/components/onboarding/PaycheckStep.tsx` | partial · s1p4 |
| `apps/rn/src/components/onboarding/WelcomeStep.tsx` | s1p3 |
...
| `apps/rn/src/components/payoff/compareStrategies.ts` | s1p3 |
...
| `apps/rn/src/components/plan/dataRepairsCopy.ts` | r17 · s1p2 · s1p4 |
| `apps/rn/src/components/plan/useCaptureAutoConfirm.ts` | never · s1p1 |
| `apps/rn/src/components/premium/PremiumInvite.tsx` | s1p3 |
...
| `apps/rn/src/components/ui/AddRow.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/AnimatedSheet.tsx` | s1p2 |
| `apps/rn/src/components/ui/AppIcon.ios.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/AppIcon.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/Button.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/Card.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/ChartSkeleton.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/CheckCircle.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/DateField.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/DateField.web.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/EmptyState.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/FormSheet.tsx` | s1p2 |
| `apps/rn/src/components/ui/ListRow.tsx` | s1p2 |
| `apps/rn/src/components/ui/MasterDetail.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/Pill.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/PressableScale.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/RadioGroup.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/RowContextMenu.ios.tsx` | s1p3 |
| `apps/rn/src/components/ui/RowContextMenu.tsx` | s1p3 |
| `apps/rn/src/components/ui/RowContextMenu.types.ts` | s1p3 |
| `apps/rn/src/components/ui/SegmentedToggle.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/Select.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/SheetBackdrop.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/SheetScrim.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/Slider.tsx` | s1p3 |
| `apps/rn/src/components/ui/SwitchRow.tsx` | ⛔ **never · partial** |
| `apps/rn/src/components/ui/TextField.tsx` | s1p3 |
...
| `apps/rn/src/hooks/use-app-lock.ts` | s1p3 |
| `apps/rn/src/hooks/use-cloud-backup.ts` | s1p3 · s1p4 |
| `apps/rn/src/hooks/use-coach-mark.ts` | never · s1p4 |
| `apps/rn/src/hooks/use-color-scheme.ts` | s1p3 |
| `apps/rn/src/hooks/use-color-scheme.web.ts` | s1p3 |
| `apps/rn/src/hooks/use-go-to-tab.ts` | s1p3 |
| `apps/rn/src/hooks/use-inert.ts` | s1p3 |
| `apps/rn/src/hooks/use-layout.ts` | s1p3 |
| `apps/rn/src/hooks/use-notification-sync.ts` | s1p2 |
| `apps/rn/src/hooks/use-payday-capture.ts` | s1p3 |
| `apps/rn/src/hooks/use-sheet-presentation.ts` | never · s1p4 |
| `apps/rn/src/hooks/use-spotlight.ts` | never · s1p4 |
| `apps/rn/src/keyCommands/KeyCommandListener.ios.tsx` | never · s1p4 |
| `apps/rn/src/keyCommands/KeyCommandListener.tsx` | never · s1p4 |
| `apps/rn/src/keyCommands/keyCommandBus.test.ts` | never · s1p4 |
| `apps/rn/src/keyCommands/keyCommandBus.ts` | never · s1p4 |
| `apps/rn/src/lib/app-lock.ts` | s1p3 |
| `apps/rn/src/lib/app-lock.web.ts` | s1p3 |
| `apps/rn/src/lib/review.ts` | s1p3 |
| `apps/rn/src/lib/review.web.ts` | s1p3 |
| `apps/rn/src/lib/scan.ts` | s1p3 |
| `apps/rn/src/lib/scan.web.ts` | s1p3 |
| `apps/rn/src/liveActivity/liveActivityBridge.native.ts` | s1p3 |
| `apps/rn/src/liveActivity/liveActivityBridge.ts` | s1p3 |
| `apps/rn/src/liveActivity/liveActivityBridge.types.ts` | s1p3 |
...
| `apps/rn/src/store/affordability.test.ts` | ⛔ **never · partial** |
...
| `apps/rn/src/store/glossary.test.ts` | ⛔ **never · partial** |
| `apps/rn/src/store/greeting.test.ts` | ⛔ **never · partial** |
| `apps/rn/src/store/greeting.ts` | s1p2 |
| `apps/rn/src/store/guardianPrediction.test.ts` | s1p3 |
...
| `apps/rn/src/store/guardianSelectors.ts` | r17 · s1p1 · s1p2 · partial |
| `apps/rn/src/store/guardianSubjects.test.ts` | ⛔ **never · partial** |
| `apps/rn/src/store/guardianSubjects.ts` | s1p2 |
| `apps/rn/src/store/guardianTrust.test.ts` | never · s1p4 |
| `apps/rn/src/store/historySelectors.ts` | s1p2 · s1p4 |
...
| `apps/rn/src/theme/elevation.ts` | ⛔ **never · partial** |
| `apps/rn/src/theme/icons.ts` | ⛔ **never · partial** |
| `apps/rn/src/theme/index.ts` | ⛔ **never · partial** |
| `apps/rn/src/theme/motion.ts` | ⛔ **never · partial** |
| `apps/rn/src/theme/spacing.ts` | ⛔ **never · partial** |
| `apps/rn/src/theme/typography.ts` | ⛔ **never · partial** |
| `apps/rn/src/types/react-native-ios-context-menu.d.ts` | never · s1p4 |
| `apps/rn/src/utils/a11y.ts` | s1p3 |
| `apps/rn/src/utils/canvaskit.ts` | s1p3 |
| `apps/rn/src/utils/confirm.ts` | s1p3 |
| `apps/rn/src/utils/debtFreeSound.ts` | s1p3 |
...
| `apps/rn/src/utils/sentry.ts` | s1p3 |
| `apps/rn/src/utils/sentry.web.ts` | s1p3 |
| `apps/rn/src/utils/share-card.ts` | s1p3 |
| `apps/rn/src/utils/share-card.web.ts` | s1p3 |
...
| `apps/rn/tests/e2e/absorb-entry.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/ack-coordinator.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/affordability.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/amount-guards.spec.ts` | s1p3 · s1p4 |
| `apps/rn/tests/e2e/analytics-optout.spec.ts` | ⛔ **never · partial** |
| `apps/rn/tests/e2e/bill-category-partition.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/blur-glass.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/bnpl.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/celebration.spec.ts` | ⛔ **never · partial** |
| `apps/rn/tests/e2e/cushion-forecast.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/earlyjourney.spec.ts` | ⛔ **never · partial** |
| `apps/rn/tests/e2e/enh-audit-screens.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/expense-reserve.spec.ts` | s1p3 |
| `apps/rn/tests/e2e/goal-pace-edit.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/goal-row-saved.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/greeting.spec.ts` | ⛔ **never · partial** |
| `apps/rn/tests/e2e/guardian-shortfall-topup.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/guardian.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/helpers/seed.ts` | s1p3 |
| `apps/rn/tests/e2e/hero-date-fit.spec.ts` | ⛔ **never · partial** |
| `apps/rn/tests/e2e/intent-undo.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/ipad-layouts.spec.ts` | ⛔ **never · partial** |
| `apps/rn/tests/e2e/misfiled-expense.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/money-add-chooser.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/no-bills-branch.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/on-plan-streak.spec.ts` | s1p3 · s1p4 |
| `apps/rn/tests/e2e/payday-reopen.spec.ts` | ⛔ **never · partial** |
| `apps/rn/tests/e2e/payoff-schedule.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/paywall.spec.ts` | s1p3 |
| `apps/rn/tests/e2e/plan-hero-conserves.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/premium-entry.spec.ts` | ⛔ **never · partial** |
| `apps/rn/tests/e2e/progress-hero-journey.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/proofofwork.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/recovery.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/route-smoke.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/saveforit-pace.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/sheet-polish.spec.ts` | s1p3 |
| `apps/rn/tests/e2e/sheet-remove.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/spoken-state.spec.ts` | ⛔ **never · partial** |
| `apps/rn/tests/e2e/strategy-compare.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/swipe-delete.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/swipe-mark-paid.spec.ts` | s1p3 |
| `apps/rn/tests/e2e/topup-sources.spec.ts` | s1p2 |
| `apps/rn/tests/e2e/trajectory-domain.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/trajectory-interactivity.spec.ts` | ⛔ **never · partial** |
| `apps/rn/tests/e2e/trials.spec.ts` | s1p3 |
| `apps/rn/tests/e2e/trust-claims.spec.ts` | ⛔ **never · partial** |
| `apps/rn/tests/e2e/variable-income.spec.ts` | never · s1p4 |
| `apps/rn/tests/e2e/vis5-cone.spec.ts` | never · s1p4 |
...
| `packages/core/debt/testAmortizationSchedule.ts` | s1p3 |
| `packages/core/debt/testApplyPaydayCapture.ts` | never · s1p4 |
| `packages/core/debt/testBnplInstallment.ts` | s1p3 · s1p4 |
| `packages/core/debt/testBnplSchedule.ts` | never · s1p4 |
| `packages/core/debt/testBuildPayoffTrajectory.ts` | s1p3 |
| `packages/core/debt/testBulkMarkRequired.ts` | never · s1p4 |
| `packages/core/debt/testComputeCycleDelta.ts` | s1p3 |
| `packages/core/debt/testComputeDrift.ts` | never · s1p4 |
| `packages/core/debt/testComputeInterestSaved.ts` | s1p3 |
| `packages/core/debt/testComputeMilestones.ts` | never · s1p4 |
| `packages/core/debt/testComputeStreak.ts` | s1p3 |
| `packages/core/debt/testDebtProjection.ts` | s1p3 · s1p4 |
| `packages/core/debt/testDeriveRequiredActionView.ts` | ⛔ **never · partial** |
| `packages/core/debt/testFreedMinimumRoll.ts` | s1p3 |
| `packages/core/debt/testGetDebtsWithDisplayBalances.ts` | never · s1p4 |
| `packages/core/debt/testGoalReconciliation.ts` | never · s1p4 |
| `packages/core/debt/testOriginalBalanceHighWater.ts` | never · s1p4 |
| `packages/core/debt/testParseDebtFormValues.ts` | never · s1p4 |
| `packages/core/debt/testPaydayCapture.ts` | never · s1p4 |
| `packages/core/debt/testProjectCurrentBalance.ts` | s1p3 |
| `packages/core/debt/testProjectionAccuracy.ts` | s1p3 |
