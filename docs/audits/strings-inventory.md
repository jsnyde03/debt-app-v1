...
**740** copy · **946** unclassified · **256** excluded as machinery · **83** copy strings appearing in more than one file (of 183 repeated strings overall).
...
- `call:allocations
      .filter`
- `call:allocations.filter`
- `call:allocations.find`
...
- `call:debts.map`
- `call:drivers.push`
- `call:expenses, nextPaycheckDate)
            .filter`
- `call:expenses, projNextDate)
                .filter`
- `call:expenses.filter`
- `call:expenses.flatMap`
- `call:findBoundary`
...
- `call:payCycle, currentDate, nextPaycheckDate), nextPaycheckDate)
        .filter`
- `call:payCycle, cycleWindowStart, projNextDate), projNextDate)
            .filter`
- `call:probeCoachMark`
- `call:recurrenceOptions`
- `call:reportError`
- `call:require`
...
- `var:PROTECTED_CUSHION_CATEGORIES`
- `var:PUT_TO_WORK_CATEGORIES`
...
**83** of 183 cross-file duplicate strings carry copy.
...
- **"one-time"** _(copy+technical+unclassified)_ — `apps/rn/src/app/(tabs)/money.tsx:71` · `apps/rn/src/app/(tabs)/money.tsx:528` · `apps/rn/src/app/(tabs)/money.tsx:529` · `apps/rn/src/app/(tabs)/money.tsx:586` · `apps/rn/src/app/(tabs)/money.tsx:587` · `apps/rn/src/app/(tabs)/money.tsx:612` · `apps/rn/src/app/(tabs)/money.tsx:614` · `apps/rn/src/app/(tabs)/money.tsx:615` · `apps/rn/src/components/entities/DebtSheet.tsx:46` · `apps/rn/src/components/entities/DebtSheet.tsx:46` · `apps/rn/src/components/entities/ExpenseSheet.tsx:17` · `apps/rn/src/components/money/BillBreakdownSheet.tsx:35` · `apps/rn/src/components/money/BillBreakdownSheet.tsx:35` · `apps/rn/src/components/money/BillBreakdownSheet.tsx:95` · `apps/rn/src/components/plan/AffordabilityCard.tsx:77` · `apps/rn/src/components/plan/AffordabilityCard.tsx:87` · `apps/rn/src/store/guardianSelectors.ts:384` · `apps/rn/src/store/obligationForm.ts:30` · `apps/rn/src/utils/format.ts:9` · `apps/rn/src/utils/format.ts:23` · `packages/core/debt/bnplPayoffPace.ts:35` · `packages/core/engine/allocatePaycheck.ts:199` · `packages/core/imports/debtCsv.ts:9` · `packages/core/recurrence/rolloverPayCycle.ts:59` · `packages/core/recurrence/rolloverPayCycle.ts:71` · `packages/core/recurrence/rolloverPayCycle.ts:104` · `packages/core/recurrence/rolloverPayCycle.ts:132` · `packages/core/timeline/buildMultiCycleTimeline.ts:148` · `packages/core/timeline/buildMultiCycleTimeline.ts:153` · `packages/core/timeline/buildMultiCycleTimeline.ts:224` · `packages/core/timeline/buildMultiCycleTimeline.ts:229` · `packages/core/types/recurrence.ts:2`
...
- **"Autopay"** _(copy+unclassified)_ — `apps/rn/src/app/(tabs)/money.tsx:469` · `apps/rn/src/app/(tabs)/money.tsx:706` · `apps/rn/src/components/entities/DebtSheet.tsx:350` · `apps/rn/src/components/entities/ExpenseSheet.tsx:103` · `apps/rn/src/components/payday/PaydayCaptureSheet.tsx:262` · `apps/rn/src/components/plan/RequiredActionsCard.tsx:258`
...
| `apps/rn/src/app/(tabs)/money.tsx:612` | `searching` | — | "one-time" |
...
| line | origin | string |
|---|---|---|
| 75 | var:isExpense ⚠️ | autopay_expense |
| 206 | var:activeAck ⚠️ | reserve-release |
| 206 | var:activeAck ⚠️ | reserve-walkback |
| 206 | var:activeAck ⚠️ | risk-cleared |
| 214 | var:activeAck ⚠️ | reserve-release |
| 216 | var:activeAck ⚠️ | reserve-walkback |
| 218 | other ⚠️ | risk-cleared |
| 233 | other ⚠️ | no-paycheck |
...
| 513 | other ⚠️ | log-payment |
| 515 | other ⚠️ | log-payment |
| 516 | other ⚠️ | Payment logged — I updated your balance. |
| 517 | other ⚠️ | Payday landed — I rolled your plan forward to this paycheck. |
| 521 | prop:label | Undo |
| 522 | prop:label | Keep |
...
| 260 | call:useCoachMark ⚠️ | debt-row-actions |
| 312 | other ⚠️ | credit-card |
| 313 | prop:title | Start your debt-free plan |
| 314 | prop:body | Add a loan, credit card, or BNPL balance to see your debt-free date. |
| 315 | prop:cta | Add |
| 317 | prop:ctaTestID ⚠️ | money-add |
| 319 | prop:label | Scan a statement |
| 319 | other ⚠️ | document-scanner |
| 334 | key:title | PAID OFF |
| 347 | prop:options ⚠️ | Snowball |
| 348 | prop:options ⚠️ | Avalanche |
| 353 | other ⚠️ | Smallest balance first — quick wins. Your debts are listed in payoff order. |
| 354 | other ⚠️ | Highest APR first — least interest. Your debts are listed in payoff order. |
| 378 | other ⚠️ | debt-row-actions |
| 382 | prop:label | Add |
| 382 | other ⚠️ | money-add |
| 384 | prop:label | Scan a statement |
| 384 | other ⚠️ | document-scanner |
| 409 | other ⚠️ | credit-card |
...
| 479 | prop:amountSuffix ⚠️ | /mo |
| 528 | call:expenses.filter ⚠️ | one-time |
| 529 | call:expenses.filter ⚠️ | one-time |
| 586 | call:expenses.filter ⚠️ | one-time |
| 587 | call:expenses.filter ⚠️ | one-time |
| 612 | call:collapsed.has ⚠️ | one-time |
| 614 | key:key ⚠️ | one-time |
| 615 | key:title | one-time |
| 639 | other ⚠️ | receipt-long |
...
| 88 | other ⚠️ | trending-down |
| 88 | other ⚠️ | trending-up |
...
| 30 | var:AUTO_RENEW_DISCLOSURE ⚠️ | Payment will be charged to your Apple Account at confirmation of purchase. Subscriptions |
| 31 | var:AUTO_RENEW_DISCLOSURE ⚠️ | automatically renew unless canceled at least 24 hours before the end of the current period. Your |
| 32 | var:AUTO_RENEW_DISCLOSURE ⚠️ | account is charged for renewal within 24 hours prior to the end of the current period. Manage or |
| 33 | var:AUTO_RENEW_DISCLOSURE ⚠️ | cancel anytime in your App Store account settings. Lifetime is a one-time purchase (not a |
| 34 | var:AUTO_RENEW_DISCLOSURE ⚠️ | subscription) that covers all current Premium features; any future add-on tiers, like bank |
| 35 | var:AUTO_RENEW_DISCLOSURE ⚠️ | connection or an AI coach, are sold separately. |
...
| 241 | other ⚠️ | You’re on Premium — Lifetime. Thanks for the support. |
| 241 | other ⚠️ | You’re on Premium — thanks for the support. |
...
| 320 | other ⚠️ | Restoring… |
| 320 | other ⚠️ | Restore purchases |
...
| 18 | var:KINDS ⚠️ | payday-landed |
| 18 | var:KINDS ⚠️ | log-payment |
| 52 | other ⚠️ | log-payment |
...
| 67 | jsx-text | Paying |
| 67 | jsx-text | /mo |
| 67 | other ⚠️ | — minimum + your extra |
| 67 | other ⚠️ | — the minimum |
| 71 | jsx-text | MONTH |
| 72 | jsx-text | BALANCE |
...
| line | origin | string |
|---|---|---|
| 34 | call:recurrenceOptions ⚠️ | per-paycheck |
| 45 | key:label | Every 3 months |
| 46 | key:label | one-time |
...
| line | origin | string |
|---|---|---|
| 17 | call:recurrenceOptions ⚠️ | per-paycheck |
| 17 | call:recurrenceOptions ⚠️ | one-time |
...
| 55 | other ⚠️ | Start a state, then check the Lock Screen / Dynamic Island. (iOS only.) |
| 56 | other ⚠️ | Live Activities are OFF in device Settings, or unsupported here (web / <iOS 16.2). |
...
| 52 | other ⚠️ | You're all set |
| 56 | other ⚠️ | That's your target — stay the course. Tap below to see exactly what to do with your next paycheck. |
| 57 | other ⚠️ | Your plan is ready. Tap below to see exactly what to do with your next paycheck. |
...
| 120 | other ⚠️ | Something with a balance you’re paying down — a card, a loan, a mortgage. It ends. |
| 121 | other ⚠️ | An ongoing cost that doesn’t end — rent, phone, a subscription. |
| 125 | other ⚠️ | field-onboarding-name |
| 126 | prop:label | Debt name |
| 126 | prop:label | Expense name |
| 132 | prop:placeholder | e.g. Visa Card |
| 132 | prop:placeholder | e.g. Rent |
| 138 | other ⚠️ | field-onboarding-balance |
| 139 | prop:label | Current balance |
| 145 | prop:placeholder | e.g. 2400 |
| 146 | other ⚠️ | decimal-pad |
| 151 | other ⚠️ | field-onboarding-minimum |
| 152 | prop:label | Minimum payment |
| 158 | prop:placeholder | e.g. 35 |
| 159 | other ⚠️ | decimal-pad |
| 163 | prop:label | APR % (optional) |
| 163 | prop:placeholder | e.g. 22.99 |
| 163 | other ⚠️ | field-onboarding-apr |
| 163 | other ⚠️ | decimal-pad |
| 169 | other ⚠️ | field-onboarding-amount |
| 170 | prop:label | Amount |
| 176 | prop:placeholder | e.g. 1200 |
| 177 | other ⚠️ | decimal-pad |
...
| 81 | other ⚠️ | field-paycheck-amount |
| 89 | other ⚠️ | decimal-pad |
| 107 | other ⚠️ | decimal-pad |
| 122 | other ⚠️ | number-pad |
| 125 | other ⚠️ | number-pad |
| 131 | other ⚠️ | number-pad |
...
| 240 | other ⚠️ | Undo |
| 240 | other ⚠️ | Mark all paid |
| 261 | other ⚠️ | Autopay · ran |
| 262 | other ⚠️ | Autopay |
| 265 | other ⚠️ | Required |
| 269 | prop:label | Paid |
...
| 354 | other ⚠️ | 1 balance hasn't been checked in a while |
...
| line | origin | string |
|---|---|---|
| 136 | var:showMinimums ⚠️ | payoff-enabling |
| 228 | call:month).toLocaleString ⚠️ | en-US |
| 229 | var:minimumsDateLabel ⚠️ | Never |
| 258 | var:gold ⚠️ | #f7cf5f |
| 258 | var:gold ⚠️ | #dca01f |
| 259 | var:axisColor ⚠️ | rgba(255,255,255,0.07) |
| 259 | var:axisColor ⚠️ | rgba(16,38,84,0.07) |
| 264 | key:areaTop ⚠️ | rgba(91,157,255,0.26) |
| 264 | key:areaTop ⚠️ | rgba(47,102,234,0.18) |
| 265 | key:areaBottom ⚠️ | rgba(91,157,255,0) |
| 265 | key:areaBottom ⚠️ | rgba(47,102,234,0) |
| 267 | key:glow ⚠️ | rgba(247,207,95,0.55) |
| 267 | key:glow ⚠️ | rgba(220,160,31,0.5) |
| 268 | key:core ⚠️ | #ffe9a8 |
| 268 | key:core ⚠️ | #eeb42e |
| 272 | key:band ⚠️ | rgba(91,157,255,0.14) |
| 272 | key:band ⚠️ | rgba(47,102,234,0.10) |
| 273 | key:lean ⚠️ | rgba(91,157,255,0.5) |
| 273 | key:lean ⚠️ | rgba(47,102,234,0.45) |
...
| 344 | call:waypoints.flatMap ⚠️ | traj-waypoint |
...
| 474 | other ⚠️ | expand-less |
| 474 | other ⚠️ | expand-more |
...
| 88 | key:areaTop ⚠️ | rgba(91,157,255,0.24) |
| 88 | key:areaTop ⚠️ | rgba(47,102,234,0.16) |
| 89 | key:areaBottom ⚠️ | rgba(91,157,255,0) |
| 89 | key:areaBottom ⚠️ | rgba(47,102,234,0) |
| 94 | key:ringCore ⚠️ | #ffffff |
| 102 | var:stateColor ⚠️ | at-risk |
| 130 | jsx-text | BREATHING ROOM |
| 177 | jsx-text | your $ |
| 185 | jsx-text | Guardian&apos;s setting aside |
| 185 | jsx-text | from this paycheck for a tight cycle ahead. |
| 193 | other ⚠️ | This paycheck |
...
| 49 | var:recalibration ⚠️ | false_clear |
...
| 44 | var:GOLDS ⚠️ | #f7cf5f |
| 44 | var:GOLDS ⚠️ | #fbe08a |
| 44 | var:GOLDS ⚠️ | #ffd873 |
| 44 | var:GOLDS ⚠️ | #fff3cf |
...
| 169 | other ⚠️ | on-track |
| 169 | other ⚠️ | check-circle |
| 169 | other ⚠️ | error-outline |
| 177 | prop:accessibilityLabel | Add extra income |
| 179 | other ⚠️ | add-circle-outline |
| 181 | other ⚠️ | Add extra income |
...
| 105 | key:textDecorationLine ⚠️ | line-through |
...
| 84 | other ⚠️ | check-box |
| 84 | other ⚠️ | check-box-outline-blank |
...
| 170 | other ⚠️ | expand-more |
| 170 | other ⚠️ | chevron-right |
...
| 273 | key:textDecorationLine ⚠️ | line-through |
...
| 121 | other ⚠️ | radio-button-checked |
| 121 | other ⚠️ | radio-button-unchecked |
| 123 | jsx-text | /paycheck |
| 128 | other ⚠️ | Saved after debt · no firm date |
| 144 | other ⚠️ | radio-button-checked |
| 144 | other ⚠️ | radio-button-unchecked |
...
| 86 | other ⚠️ | expand-less |
| 86 | other ⚠️ | expand-more |
...
| 565 | call:allocations.filter ⚠️ | starter_emergency |
| 565 | call:allocations.filter ⚠️ | optional_goal |

### `apps/rn/src/store/guardianSubjects.ts`

| line | origin | string |
|---|---|---|
| 40 | var:GUARDIAN_CARD_SUBJECTS ⚠️ | guardian-card |
| 40 | var:GUARDIAN_CARD_SUBJECTS ⚠️ | guardian-bar |
| 40 | var:GUARDIAN_CARD_SUBJECTS ⚠️ | guardian-adjust |
| 40 | var:GUARDIAN_CARD_SUBJECTS ⚠️ | guardian-reserve |
| 61 | var:ids ⚠️ | guardian-card |
| 61 | var:ids ⚠️ | guardian-bar |
| 64 | other ⚠️ | at-risk |
...
| 27 | key:'per-paycheck' ⚠️ | per-paycheck |
...
| 33 | key:sublabel ⚠️ | e.g. 1st & 15th |
...
| line | origin | string |
|---|---|---|
| 16 | var:REQUIRED_CATEGORIES ⚠️ | minimum_debt |
| 16 | var:REQUIRED_CATEGORIES ⚠️ | autopay_expense |
| 16 | var:REQUIRED_CATEGORIES ⚠️ | autopay_debt |
| 57 | call:allocations
      .filter ⚠️ | starter_emergency |
| 57 | call:allocations
      .filter ⚠️ | optional_goal |
| 96 | other ⚠️ | Unable to estimate |
| 128 | var:isExpense ⚠️ | autopay_expense |
| 135 | key:isAutopay ⚠️ | autopay_expense |
| 135 | key:isAutopay ⚠️ | autopay_debt |
| 145 | call:rows.filter ⚠️ | autopay_expense |
| 149 | call:rows
      .filter ⚠️ | minimum_debt |
| 149 | call:rows
      .filter ⚠️ | autopay_debt |
| 211 | var:isExpense ⚠️ | autopay_expense |
...
| 274 | return | no-paycheck |
| 276 | other ⚠️ | debt-free |
| 276 | other ⚠️ | no-debts |
...
| 193 | call:findBoundary ⚠️ | at-risk |
| 351 | var:SANDBOX_STATES ⚠️ | at-risk |
...
| 9 | var:MONTHLY_FACTOR ⚠️ | per-paycheck |
| 9 | var:MONTHLY_FACTOR ⚠️ | one-time |
| 23 | other ⚠️ | one-time |
| 24 | other ⚠️ | per-paycheck |
...
| line | origin | string |
|---|---|---|
| 26 | call:items.map ⚠️ | optional_goal |
...
|---|---|---|
| 28 | other ⚠️ | on_track |
| 108 | var:status ⚠️ | on_track |
| 110 | key:onTrack ⚠️ | on_track |
...
| line | origin | string |
|---|---|---|
| 62 | var:isExpenseItem ⚠️ | autopay_expense |
| 64 | var:isDebtItem ⚠️ | minimum_debt |
| 64 | var:isDebtItem ⚠️ | autopay_debt |
| 81 | var:isAutopay ⚠️ | autopay_expense |
| 81 | var:isAutopay ⚠️ | autopay_debt |
...
| line | origin | string |
|---|---|---|
| 66 | call:allocations.filter ⚠️ | starter_emergency |
| 76 | call:allocations.filter ⚠️ | optional_goal |
| 98 | call:allocations
        .filter ⚠️ | cushion_buffer |
| 99 | call:allocations
        .filter ⚠️ | discovery_holdback |
| 100 | call:allocations
        .filter ⚠️ | prefunded_reserve |
...
| 71 | var:PROTECTED_CUSHION_CATEGORIES ⚠️ | cushion_buffer |
| 72 | var:PROTECTED_CUSHION_CATEGORIES ⚠️ | prefunded_reserve |
| 73 | var:PROTECTED_CUSHION_CATEGORIES ⚠️ | discovery_holdback |
| 74 | var:PROTECTED_CUSHION_CATEGORIES ⚠️ | true_leftover |
| 79 | var:PUT_TO_WORK_CATEGORIES ⚠️ | starter_emergency |
| 82 | var:PUT_TO_WORK_CATEGORIES ⚠️ | optional_goal |
| 97 | other ⚠️ | minimum_debt |
| 97 | other ⚠️ | autopay_expense |
| 97 | other ⚠️ | autopay_debt |
| 199 | other ⚠️ | one-time |
| 326 | other ⚠️ | minimum_debt |
| 327 | other ⚠️ | autopay_debt |
...
| 74 | other ⚠️ | optional_goal |
| 106 | other ⚠️ | optional_goal |
...
| 215 | key:safeMove ⚠️ | Update your numbers and I'll plan from where you actually are. |
...
| 323 | key:safeMove ⚠️ | to your goals |
| 323 | key:safeMove ⚠️ | to debt |
| 333 | key:title | Looks clear this paycheck |
| 335 | key:safeMove ⚠️ | your goals |
...
| 63 | other ⚠️ | false_clear |
| 63 | other ⚠️ | false_tight |
| 110 | other ⚠️ | false_clear |
| 115 | var:dominantError ⚠️ | dominantError |
| 119 | var:dominantError ⚠️ | false_clear |
| 120 | var:dominantError ⚠️ | false_tight |
...
| line | origin | string |
|---|---|---|
| 9 | var:allowedRecurrences ⚠️ | one-time |
| 9 | var:allowedRecurrences ⚠️ | per-paycheck |
...
| 59 | other ⚠️ | one-time |
| 71 | other ⚠️ | one-time |
| 75 | other ⚠️ | per-paycheck |
| 104 | call:expenses.flatMap ⚠️ | one-time |
| 132 | call:debts.map ⚠️ | one-time |

### `packages/core/scan/parseStatementText.ts`

| line | origin | string |
|---|---|---|
| 26 | var:ISSUERS ⚠️ | American Express |
| 26 | var:ISSUERS ⚠️ | Amex |
| 26 | var:ISSUERS ⚠️ | Capital One |
| 26 | var:ISSUERS ⚠️ | Bank of America |
| 26 | var:ISSUERS ⚠️ | Wells Fargo |
| 26 | var:ISSUERS ⚠️ | Apple Card |
| 27 | var:ISSUERS ⚠️ | Chase |
| 27 | var:ISSUERS ⚠️ | Citi |
| 27 | var:ISSUERS ⚠️ | Citibank |
| 27 | var:ISSUERS ⚠️ | Discover |
| 27 | var:ISSUERS ⚠️ | Barclays |
| 27 | var:ISSUERS ⚠️ | Synchrony |
| 27 | var:ISSUERS ⚠️ | U.S. Bank |
| 27 | var:ISSUERS ⚠️ | US Bank |
| 28 | var:ISSUERS ⚠️ | PNC |
| 28 | var:ISSUERS ⚠️ | TD Bank |
| 28 | var:ISSUERS ⚠️ | USAA |
| 28 | var:ISSUERS ⚠️ | Navy Federal |
| 28 | var:ISSUERS ⚠️ | Klarna |
| 28 | var:ISSUERS ⚠️ | Affirm |
| 28 | var:ISSUERS ⚠️ | Afterpay |
| 28 | var:ISSUERS ⚠️ | PayPal |
| 28 | var:ISSUERS ⚠️ | Zip |
| 28 | var:ISSUERS ⚠️ | Sezzle |
| 86 | var:AMT ⚠️ | [^\n\d]{0,30}\$?\s*([\d,]+\.\d{2}) |
...
| line | origin | string |
|---|---|---|
| 148 | call:expenses, nextPaycheckDate)
            .filter ⚠️ | one-time |
| 153 | call:payCycle, currentDate, nextPaycheckDate), nextPaycheckDate)
        .filter ⚠️ | one-time |
| 224 | call:expenses, projNextDate)
                .filter ⚠️ | one-time |
| 229 | call:payCycle, cycleWindowStart, projNextDate), projNextDate)
            .filter ⚠️ | one-time |
| 274 | other ⚠️ | starter_emergency |
| 274 | call:allocations
            .filter ⚠️ | optional_goal |
...
| 80 | key:type ⚠️ | autopay_expense |
| 98 | key:type ⚠️ | autopay_debt |
| 98 | key:type ⚠️ | minimum_debt |
| 106 | call:allocations.find ⚠️ | cushion_buffer |
| 111 | key:label | Cash Buffer |
| 125 | key:type ⚠️ | optional_goal |
| 139 | call:items].sort ⚠️ | living_reserve |
| 143 | call:items].sort ⚠️ | living_reserve |
