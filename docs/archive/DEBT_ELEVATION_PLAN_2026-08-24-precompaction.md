# ARCHIVE — DEBT_ELEVATION_PLAN.md as it stood 2026-08-24, before the compaction

> Verbatim snapshot taken at the P6.8.7g.0 cleanup (🎯: *"there are a lot of decomposed and stale
> sections there that shouldn't be"*). 1,278 lines. The live plan is
> [`../DEBT_ELEVATION_PLAN.md`](../DEBT_ELEVATION_PLAN.md); per-item detail is in
> [`../DEBT_ELEVATION_LOG.md`](../DEBT_ELEVATION_LOG.md). Nothing here is a driver — archaeology only.
