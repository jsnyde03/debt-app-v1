...
- Name: app-store-screenshots.spec.ts >> 01 — Plan overview (dark)
- Location: tests\e2e\app-store-screenshots.spec.ts:190:5
...
```ts
  94  |             type: "debt",
  95  |             recurrence: "monthly",
  96  |             isPaidThisCycle: false,
  97  |             minimumPaidThisCycle: false,
  98  |             snowballPaidThisCycle: false,
  99  |             isAutopay: true,
  100 |         },
  101 |         {
  102 |             id: "debt-medical",
  103 |             name: "Medical Bill",
  104 |             balance: 620,
  105 |             originalBalance: 620,
  106 |             minimumPayment: 25,
  107 |             apr: 0,
  108 |             dueDate: "2026-06-26",
  109 |             originalDueDate: "2026-06-26",
  110 |             type: "debt",
  111 |             recurrence: "monthly",
  112 |             isPaidThisCycle: false,
  113 |             minimumPaidThisCycle: false,
  114 |             snowballPaidThisCycle: false,
  115 |             isAutopay: false,
  116 |         },
  117 |     ],
  118 | 
