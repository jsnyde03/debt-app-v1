...
export function demoStore(): DebtStore {
  ...
  return {
    ...
    debts: [
      { id: 'demo-store', name: 'Store Card', balance: 180, originalBalance: 1200, minimumPayment: 30, apr: 22.99, dueDate: currentDate, type: 'debt', recurrence: 'monthly', lastVerifiedDate: daysAgo(8), balanceAsOfDate: daysAgo(8) },
      { id: 'demo-visa', name: 'Visa', balance: 2400, originalBalance: 4200, minimumPayment: 65, apr: 26.99, dueDate: currentDate, type: 'debt', recurrence: 'monthly', lastVerifiedDate: daysAgo(38), balanceAsOfDate: daysAgo(38) },
      { id: 'demo-car', name: 'Car Loan', balance: 9000, originalBalance: 13500, minimumPayment: 260, apr: 6.5, dueDate: currentDate, type: 'debt', recurrence: 'monthly', lastVerifiedDate: daysAgo(52), balanceAsOfDate: daysAgo(52) },
    ],
    requiredExpenses: [
